 ...
 */
final class Version20190405143948 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE sav ADD CONSTRAINT FK_6C7681F4249E6EA1 FOREIGN KEY (dealer_id) REFERENCES dealer (id)');
