...
final class SavNewAdmin extends AbstractAdmin
{
    protected $baseRoutePattern = 'sav-new';
    protected $baseRouteName = 'sav_new';
    ...
    public function createQuery($context = 'list')
    {
        ...
        $query->andWhere($query->getRootAlias() . '.isNew = :true OR ' . $query->getRootAlias() . '.newMessage = :true OR ' . $query->getRootAlias() . '.statusSetting = :one')
