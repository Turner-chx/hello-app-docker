...
class AppImportDealerCommand extends Command
{
    protected static $defaultName = 'lama:import:dealer';
    protected $em;
    ...
    {
        $this->setDescription('Importe les clients depuis le fichier ClientsIntranet.csv');
    }

    protected function execute(InputInterface $input, OutputInterface $output)
    {
        $filename = 'ClientsIntranet.csv';
